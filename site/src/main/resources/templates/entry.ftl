...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${generatedRoot}/icons/icons.css">
  </head>
  <body>
    ...
    <link rel="stylesheet" href="${root}/static/emi/emi.css">
    <script src="${root}/static/emi/emi.min.js"></script>
    <script src="${root}/static/handbook-emi.js"></script>
